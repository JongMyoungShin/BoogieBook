...
<div class="container" style="border: 0px solid blue; margin: 0px auto; height:400px; margin-top:50px; ">
	<div class="row">
	...
	<div class="container" style="border: 0px solid red; margin: 0px auto; height: 700px; margin-bottom: 250px;">
    ...
    <div class="col-md-8" style="width: 1000px; height: 700px; margin: 0px auto;">  
        ...
        <hr>
        <form class="form-horizontal" action="${root}/member/registerOk.do" method="get" name="signup" id="signup" enctype="multipart/form-data"
        ...
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
              ...
              <input type="text" style="width: 350px" class="form-control" name="member_id" id="id" placeholder="아이디를 입력하세요." oninput="checkId()">
            </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="password" style="width: 350px" class="form-control" name="password" id="password" placeholder="비밀번호를 입력하세요." oninput="checkPassword()">
           </div>   
